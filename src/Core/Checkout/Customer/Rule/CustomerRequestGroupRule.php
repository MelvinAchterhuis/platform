...
class CustomerRequestGroupRule extends Rule
{
    /**
    ...
    public function match(RuleScope $scope): bool
    {
        ...
        return RuleComparison::uuids([$scope->getSalesChannelContext()->getCustomer()->getRequestedGroupId()], $this->customerGroupIds, $this->operator);
    }
    ...
    {
        return 'customerCustomerRequestGroup';
    }
