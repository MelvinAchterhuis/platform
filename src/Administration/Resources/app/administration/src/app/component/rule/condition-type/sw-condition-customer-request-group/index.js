import template from './sw-condition-customer-request-group.html.twig';
 ...
 * @public
 * @description Condition for the CustomerRequestGroupRule. This component must a be child of sw-condition-tree.
 * @status prototype
 * @example-type code-only
 * @component-example
 * <sw-condition-customer-request-group :condition="condition" :level="0"></sw-condition-customer-request-group>
 */
Component.extend('sw-condition-customer-request-group', 'sw-condition-base', {
    template,
    inheritAttrs: false,
